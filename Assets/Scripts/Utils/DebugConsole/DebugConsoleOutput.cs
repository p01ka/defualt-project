...
#pragma warning disable 0649
        ...
        // [Inject] private INotificationFacade _notificationFacade;

        // [Inject] private IUserStatusSetter _statusSetter;

        // [Inject] private ILocalizationFacade _localizationFacade;

        // [Inject] private IMobileNativeMessage _mobileNativeMessage;
...
#pragma warning restore 0649
        ...
        private class LogItem
        {
            ...
            public string StackTrace { private get; set; }

            public override string ToString()
            {
                string msg = $"{Time:HH:mm:ss.fff} [{Type.ToString().ToUpper()}] {Message}";
        ...
        private readonly Queue<LogItem> _addQueue = new Queue<LogItem>();
        private Vector2 _scrollPosition = Vector2.zero;

        private Vector2 _lastMousePosition = Vector2.zero;
        private bool _isMousePressed;

        private readonly List<ListItem> _viewItems = new List<ListItem>();
        ...
        private Rect _deleteAllKeys;
        private Rect _changePremiumStatus;
        private Rect _changeLanguage;
        private Rect _subscreenButton;
        private Rect _setTestPush;
        private Rect _showNextMobileMessage;
        ...
        private void UpdateLayoutInternal()
        {
            ...
            _showHideButtonRect = new Rect(Screen.width * 0.5f - buttonWidth * 2f, buttonHeight * 2f, buttonWidth * 2f, buttonHeight * 2f);

            _scrollToEndButtonRect = _showHideButtonRect;
            _scrollToEndButtonRect.x += _scrollToEndButtonRect.width + space;

            _deleteAllKeys = new Rect(Screen.width * 0.5f - buttonWidth * 2f, buttonHeight * 5f, buttonWidth * 2f, buttonHeight * 2f);

            _changePremiumStatus = new Rect(Screen.width * 0.5f + space, buttonHeight * 5f, buttonWidth * 2f, buttonHeight * 2f);

            _changeLanguage = new Rect(Screen.width * 0.5f + space, buttonHeight * 8f, buttonWidth * 2f, buttonHeight * 2f);

            _showNextMobileMessage = new Rect(Screen.width * 0.5f + space, buttonHeight * 11f, buttonWidth * 2f, buttonHeight * 2f);

            _subscreenButton = new Rect(Screen.width * 0.5f - buttonWidth * 2f, buttonHeight * 8f, buttonWidth * 2f, buttonHeight * 2f);

            _setTestPush = new Rect(Screen.width * 0.5f - buttonWidth * 2f, buttonHeight * 11f, buttonWidth * 2f, buttonHeight * 2f);
        ...
        private int FindVisibleItemIndex()
        {
            ...
            while (first < last)
            {
                ...
                if (rect.yMin < _scrollViewRect.y)
                {
                    first = middle + 1;
                }
                else
        ...
        private bool _isVisibleItemsChanged;
        ...
        private List<ListItem> _cachedVisibleItems;
        ...
        private void AddToEndOfList(LogItem item)
        {
            ...
            var listItem = new ListItem { Content = new GUIContent(log) };
        ...
        private void ProcessItems(int max = 8)
        {
            lock (_addQueue)
            {
                int processed = 0;
        ...
        protected GUIStyle GeneralItemStyle => _generalItemStyle ?? (_generalItemStyle = new GUIStyle(GUI.skin.label) { wordWrap = true });

        private readonly Dictionary<Color, GUIStyle> _itemStylesCache = new Dictionary<Color, GUIStyle>();

        private GUIStyle GetStyleForItem(Color color)
        {
            if (_itemStylesCache.TryGetValue(color, out var style))
                return style;
        ...
        private bool _userTestStatus;
        private bool _pushStatus;
        private bool _isEngLanguage;
        ...
        private void OnGUI()
        {
            ...
            if (GUI.Button(_deleteAllKeys, "DELETE ALL KEYS"))
            {
                bool status = Caching.ClearCache();
            ...
            // if (GUI.Button(_subscreenButton, "SHOW SUB SCREEN"))
            // {
            //     _signals.TryFire<ApplicationSignals.OnOpenSubscribeScreen>();
            // }

            // if (GUI.Button(_setTestPush, "SET TEST PUSH"))
            // {
            //     _notificationFacade.SetTestPush();
            // }

            // if (GUI.Button(_changePremiumStatus, "CHANGE PREMIUM STATUS"))
            // {
            //     _statusSetter.IsPremiumUser = !_statusSetter.IsPremiumUser;
            // }

            // if (GUI.Button(_changeLanguage, "CHANGE LANGUAGE"))
            // {
            //     _isEngLanguage = !_isEngLanguage;
            //     _localizationFacade.CurrentLanguage = _isEngLanguage ?
            //                                                          CultureInfo.GetCultureInfo("en-US") :
            //                                                          CultureInfo.GetCultureInfo("ru-RU");
            // }

            // if (GUI.Button(_showNextMobileMessage, "SHOW NEXT MESSAGE"))
            // {
            //     switch (_messageIndex)
            //     {
            //         case 0:
            //             _mobileNativeMessage.NoInternetConnectionMessage();
            //             break;
            //         case 1:
            //             _mobileNativeMessage.ShowAntiCheatMessage();
            //             break;
            //         case 2:
            //             _mobileNativeMessage.ShowErrorDownloadMessage();
            //             break;
            //         case 3:
            //             _mobileNativeMessage.ShowNotEnoughSpaceOnDiskMessage(100);
            //             break;
            //         case 4:
            //             _mobileNativeMessage.ShowNameIsEmptyMessage();
            //             break;
            //         case 5:
            //             _mobileNativeMessage.ShowNameAlreadyExists();
            //             break;
            //         case 6:
            //             _mobileNativeMessage.ShowNameTooLongMessage();
            //             break;
            //         case 7:
            //             _mobileNativeMessage.ShowNameConsistsInvalidCharsMessage();
            //             break;
            //         case 8:
            //             _mobileNativeMessage.ShowDeleteCreatedItemDialog("testItem", null);
            //             break;
            //         case 9:
            //             _mobileNativeMessage.ShowLiveWallpaperSavedMessage(null);
            //             break;
            //         case 10:
            //             _mobileNativeMessage.ShowVideoSavedToGalleryMessage("testFolder", null);
            //             break;
            //         case 11:
            //             _mobileNativeMessage.ShowWallpaperAlreadySavedMessage();
            //             break;
            //         case 12:
            //             _mobileNativeMessage.ShowVideoAlreadySavedMessage();
            //             break;
            //         case 13:
            //             _mobileNativeMessage.ShowDecorSelectionNotAvailableMessage();
            //             break;
            //         case 14:
            //             _mobileNativeMessage.ShowOfferToRateAppMessage(null);
            //             break;
            //     }
            //     _messageIndex++;
            //     if (_messageIndex >= 15)
